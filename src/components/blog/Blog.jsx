    ...
    <section id='blog'>
      <div className="blog">
        ...
        <div className="blogcard">
          ...
          <a href="https://medium.com/@disaradm07/trophy-employee-loyalty-app-ui-ux-case-study-32f781794a92">
        ...
        <div className="blogcard">
          ...
          <a href="https://medium.com/@disaradm07/can-we-use-ai-personas-for-user-testing-8cfe64d1f0f7">
            <span>READ FULL ARTICLE ON MEDIUM</span>
          </a>
        </div>
        <div className="blogcard">
          ...
          <a href="https://medium.com/@disaradm07/watts-gamified-power-saving-mobile-app-ui-ux-case-study-f3f4c57db871">
            <span>READ FULL ARTICLE ON MEDIUM</span>
          </a>
        </div>
      </div>
