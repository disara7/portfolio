...
const Blog = () => {
  return (
    ...
    <div className="blogcard">
      ...
      <a href="https://medium.com/@disaradm07/trophy-employee-loyalty-app-ui-ux-case-study-32f781794a92">READ FULL ARTICLE ON MEDIUM</a>
    </div>
    <div className="blogcard">
      ...
      <a href="https://medium.com/@disaradm07/can-we-use-ai-personas-for-user-testing-8cfe64d1f0f7">READ FULL ARTICLE ON MEDIUM</a>
    </div>
    <div className="blogcard">
      ...
      <a href="https://medium.com/@disaradm07/watts-gamified-power-saving-mobile-app-ui-ux-case-study-f3f4c57db871">READ FULL ARTICLE ON MEDIUM</a>
    </div>
